...
داشتم فکر میکردم که خیلی خوب میشه اگر به تمام کانال های آموزشی تو حوزه تکنولوژی و برنامه نویسی فارسی بشه توی یک لیست دسترسی داشت، برای همین این لیست رو ساختم. و خب هیچ کدوم از این کانال ها رو تایید یا رد نمیکنم، ترتیب خاصی هم نداره نوشتنشون
